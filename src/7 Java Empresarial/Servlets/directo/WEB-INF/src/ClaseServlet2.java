...
public class ClaseServlet2 extends HttpServlet {
	...
	public void init(ServletConfig config) throws ServletException {
		...
		super.init(config);
		System.out.println("TRON: ClaseServlet2.init()");
	}
	...
	**/
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException{
		...
		String html = "(ClaseServlet2): Tenemos que construir todo el documento \"a pelo\".";
