...
public class Empleado{
	...
	public Empleado(int id, String nombre, String apellidos, LocalDate fechaNacimiento, Departamento departamento) throws Exception{
		this.id = id;
		this.nombre = nombre;
	...
	public Empleado(String nombre, String apellidos, LocalDate fechaNacimiento, Departamento departamento) throws Exception{
		this.nombre = nombre;
		this.apellidos = apellidos;
		this.fechaNacimiento = fechaNacimiento;
		this.departamento = departamento;
